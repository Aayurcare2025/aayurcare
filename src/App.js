    ...
    <div className="App">
      <ul className={`navbar ${menuOpen ? 'active' : ''}`}>
        ...
        >
          ...
          {showDropdown && (
            <ul className="dropdown-menu">
              <li onClick={() => { navigate("/services/individual"); setMenuOpen(false); setShowDropdown(false); }}>
                Individual
              </li>
            </ul>
          )}
        ...
        <li onClick={() => { navigate("/claims"); setMenuOpen(false); }}>
          OPD Claims
        </li>
        
        <li 
          onClick={() => { window.location.href = "https://link.mypillo.in/kckszz"; setMenuOpen(false); }}
          style={{ cursor: "pointer" }}
        >
          Medicine Delivery
        </li>
        ...
        {!isLoggedIn ? (
          <>
            <li onClick={() => { navigate("/signin"); setMenuOpen(false); }}>
              Sign In
            </li>
            <li onClick={() => { navigate("/signup"); setMenuOpen(false); }}>
              Sign Up
            </li>
          </>
        ) : (
          <li onClick={() => { setIsLoggedIn(false); setMenuOpen(false); navigate("/"); }}>
            Sign Out
          </li>
        )}
