...
export default function AayurcareSignup() {
  ...
  useEffect(() => {
    const styleSheet = document.createElement("style");
    styleSheet.id = "aayurcare-signup-styles";
    styleSheet.textContent = `
      @keyframes float {
        0%, 100% { transform: translateY(0px); }
        50% { transform: translateY(-20px); }
    ...
    if (!document.getElementById("aayurcare-signup-styles")) {
      document.head.appendChild(styleSheet);
    }

    return () => {
      const existingStyle = document.getElementById("aayurcare-signup-styles");
      if (existingStyle) {
    ...
    <div className="signup-container">
      ...
      <div className="left-section">
        <div className="left-content">
          <h1 className="welcome-title">Welcome to Aayurcare</h1>
          <p className="welcome-subtitle">Start Your Journey With Us.</p>
          
          <div className="features-container">
            <div className="feature">
              <Heart size={24} color="#fff" />
              <span className="feature-text">OPD Membership Plans</span>
            </div>
            <div className="feature">
              <Shield size={24} color="#fff" />
              <span className="feature-text">Hassle Free Claims</span>
            </div>
            <div className="feature">
              <Users size={24} color="#fff" />
              <span className="feature-text">Family Bundled Protection</span>
            </div>
          </div>
        </div>
      </div>
